...
namespace System.Threading
{
    ...
    internal sealed partial class PortableThreadPool
    {
        ...
        private static readonly short s_minWorkerThreadLimit = AppContextConfigHelper.GetInt16Config("System.Threading.ThreadPool.MinThreadsLimit", 32, false);
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        {
            _minThreads = s_forcedMinWorkerThreads > 0 ?
                s_forcedMinWorkerThreads :
                (short)Math.Min(Environment.ProcessorCount, s_minWorkerThreadLimit);
